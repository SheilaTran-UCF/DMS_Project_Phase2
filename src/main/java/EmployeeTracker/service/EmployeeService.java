...
public class EmployeeService {
    ...
    public String generateTenureReportText() {
        Map<String, List<Employee>> report = generateTenureReport();
        StringBuilder sb = new StringBuilder("Employee Tenure Report:\n");

        for (Map.Entry<String, List<Employee>> entry : report.entrySet()) {
            sb.append("\n").append(entry.getKey()).append(":\n");
            for (Employee e : entry.getValue()) {
                sb.append(" - ").append(e.getName())
                        .append(" (Hired: ").append(e.getHireDate()).append(")\n");
            }
        }
